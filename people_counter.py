...
# object on the output 
    ...
    if oldtotalDown != totalDown:
        print("[INFO] Total Down:{:.2f} Time: {:}".format(totalDown,datetime.datetime.now()))
        oldtotalDown = totalDown
    if oldtotalUp != totalUp:
        print("[INFO] Total Up:{:.2f} Time: {:}".format(totalUp,datetime.datetime.now()))
        oldtotalUp = totalUp
